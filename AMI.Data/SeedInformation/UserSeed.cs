...
namespace AMI.Data.SeedInformation
{
    public static class UserSeed
    {
        public static ApplicationUser Seed(UserManager<ApplicationUser> userManager, ABETContext context)
        {
            ...
            CreateUserWithUserNameAndEmail(userManager, "Henry", "Ledgard", "henry.ledgard", "henry.ledgard@utoledo.edu");
            CreateUserWithUserNameAndEmail(userManager, "David", "Ridner", "david.ridner", "david.ridner@gmail.com");
