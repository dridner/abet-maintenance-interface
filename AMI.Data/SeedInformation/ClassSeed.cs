...
namespace AMI.Data.SeedInformation
{
    public static class ClassSeed
    {
        public static void Seed(ABETContext context, ApplicationUser systemUserAccount, UserManager<ApplicationUser> userManager)
        {
            ...
            newClass = CreateClass(context, systemUserAccount, "EECS Professional Development", "EECS", "2000", "Understand the differences between patent, copyright, and trademark protection.",
            ...
            newClass = CreateClass(context, systemUserAccount, "Computer Organization and Assembly Programming", "EECS", "2100", "Program a simple machine using microcode to implement specific instructions.",
                "Write programs using assembly language demonstrating an ability to use subprogram linkage, basic processor functions, and control structures.",
                "Understand modern computer architecture enhancements and be able to compare and contrast processors.",
                "Understand the memory hierarchy and its importance and impact on processor performance.",
